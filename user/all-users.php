    ...
    <div class="container">
      <div class="row clearfix">
          <div class="col-md-12 column">
              <div class="row clearfix">
                <?php 
                  $sql = "SELECT * FROM member_profiles WHERE username != '$current_user' order by id desc";
                            ...
                            <div id="panel-element-<?php echo $rws['id']; ?>" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <div class="col-md-6 column">
                                        <img src="/memberfiles/avatars/<?php echo $rws['member_avatar'];?>" name="aboutme" class="img-responsive">                                  
                                    </div>
                                    <div class="col-md-6 column">
                                        <h2><span><a href="profile.php?username=<?php echo $rws['username'];?>"><?php echo $rws['member_firstname'];?> <?php echo $rws['member_lastname'];?></a></span></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
